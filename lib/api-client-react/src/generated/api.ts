...
export type ListDesignsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listDesigns>>
>;
export type ListDesignsQueryError = ErrorType<ErrorEnvelope>;
...
export type CreateDesignMutationError = ErrorType<ErrorEnvelope>;
...
export type GetDesignQueryResult = NonNullable<
  Awaited<ReturnType<typeof getDesign>>
>;
export type GetDesignQueryError = ErrorType<ErrorEnvelope>;
...
export type UpdateDesignMutationError = ErrorType<ErrorEnvelope>;
...
export const deleteDesign = async (
  ...
  return customFetch<LogoutSuccess>(getDeleteDesignUrl(id), {
    ...options,
    method: "DELETE",
  });
};
...
export type DeleteDesignMutationError = ErrorType<ErrorEnvelope>;
